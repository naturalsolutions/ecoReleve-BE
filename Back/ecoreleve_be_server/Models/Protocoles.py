...
# class ObservationImage(HasStaticProperties, Base):
#      __tablename__ = 'ObservationImage'

#     ID = Column(Integer, Sequence(
#         'ObservationImage__id_seq'), primary_key=True)
#     FK_Observation = Column(Integer, ForeignKey('Observation.ID'), nullable=False)
#     creationDate = Column(DateTime, default=func.now())
